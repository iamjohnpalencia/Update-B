...
Public Class Loading
    ...
    Private Sub GetNewUpdates()
        Try
            ...
            Dim request As FtpWebRequest = WebRequest.Create(FTPServer & "/software-update-b/update-b.zip")
            request.Credentials = New NetworkCredential(FTPUSername, FTPPassword)
            request.Method = WebRequestMethods.Ftp.DownloadFile

            Using ftpStream As Stream = request.GetResponse().GetResponseStream(), fileStream As Stream = File.Create(Application.StartupPath & "\update\update-b.zip")
    ...
    Private Sub extract()
        Try
            ...
            Dim zipPath As String = Application.StartupPath & "\update\update-b.zip"
